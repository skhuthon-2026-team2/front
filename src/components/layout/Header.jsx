    ...
    <header className="sticky top-0 z-10 border-b border-gray-200/70 bg-[#faf9f8]">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center gap-6 px-6">
        <Link to="/main" className="flex shrink-0 items-center gap-2">
          ...
          <span className="hidden text-xs text-gray-400 lg:inline">모아 담다, 우리의 기록</span>
        </Link>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative flex h-full items-center px-3 text-sm font-medium transition-colors ${
                    isActive ? "text-modam-coral" : "text-gray-500 hover:text-gray-800"
                  }`
                }
              >
                {({ isActive }) => (
